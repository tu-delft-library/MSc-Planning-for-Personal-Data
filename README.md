...
`<This repository holds the text and images for the data literacy mini-module "MSc Planning for Personal Data">`

## Contributors
- `<Paige Folsom, Narmin Rzayeva, Janine Strandberg, Nicolas Dintzner>`
