...
> `<Title of Chapter or Page>`. In `Folsom, P., Ryazeva, N.` (`2025`) _`MSc Planning for Personal Data Mini-module`_. `<url to specific page on book website>`. Source files at `<https://github.com/TUDelft-books/MSc-Planning-for-Personal-Data>`. CC BY 4.0.
